...
!function t(e, n, r) {
    ...
    1: [function(t, e, n) {
        "use strict";
        var r = t("../main");
        "function" == typeof define && define.amd ? define(r) : (window.PerfectScrollbar = r,
        ...
        function r(t, e) {
            ...
            function o(e, n) {
                ...
                if (r) {
                    ...
                    if (l > 0 && !(0 === r.scrollLeft && e < 0 || r.scrollLeft === l && e > 0))
                        return !0
                }
                return !1
            }
    ...
    19: [function(t, e, n) {
        ...
        e.exports = function(t) {
            ...
            t.contains(e.scrollbarYRail) || (n = s.queryChildren(t, ".ps-scrollbar-y-rail"),
            n.length > 0 && n.forEach(function(t) {
                s.remove(t)
            }),
