...
(function (root, factory) {
    ...
    var book_list_pic108={
        init:function(){           
            $('.book_list_108 .book_name a').attr('title',function(){
             return $(this).text();
           });
            $('.book_list_108 .shop_info').attr('title',function(){
             return $(this).text();
           });
            $('.book_list_108 .pic a').attr('title',function(){
             var nameText=$(this).parent().next('.text_height').find('.book_name').text();
             return nameText; 
           });
           $('.book_list_108 .pic a img').attr('alt',function(){
             var nameText=$(this).parent().attr('title');
             return nameText; 
           });
        }
    };
    book_list_pic108.init();
    return book_list_pic108;
}));