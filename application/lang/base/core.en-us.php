...
return [
    ...
    '_NO_CACHE_CONFIG_'      => 'Not define the cache configuration,cache name:{:name}',
    ...
    '_METHOD_IS_NOT_PUBLIC_' => 'The method access permission is not public!',
    ...
    '_FILE_OPEN_ERROR_'      => 'File open failed,filename:{:filename}',
];
